...
function InfoSection() {
  ...
  const AgeInYear = (e) => {
    ...
    if (currentDay < birthDay) {
      ...
      setUserAgeInfo({
        age: `${years} years ${months} months and ${currentDay - birthDay} days`,
        ageInYears: years,
  ...
  return (
    <section className="mx-auto flex flex-col items-center justify-center gap-8 px-4 pt-5 sm:w-[80%] sm:px-0 md:w-[70%]">
      ...
      {formSubmitted && showUserDetails ? (
        <BoxContainer contentClass=" flex flex-col gap-5 ">
          ...
          <div className="flex justify-around items-center">
            <span className="w-[45%] text-center px-3 py-2 bg-gradient-to-b from-purple-400/60 to-white/60 rounded-md">
          ...
          <button className="bg-gradient-to-b from-orange-700 to-orange-500 mx-auto px-5 py-2 rounded-md" onClick={resetForm}>Close </button>
        </BoxContainer>
      ) : (
        <>
          <form
      ...
      <div className="w-full space-y-8 sm:w-[90%]  md:w-[80%]">
        ...
        <div className=" my-8 flex w-full flex-col flex-wrap items-center justify-center gap-4 sm:flex-row sm:gap-8 md:flex-row">
          <BoxContainer heading="Appearance Age" >
            Appearance age or perceived age describes how young you look.
            Scientifically, people look visually older as their chronological
            age increases. However, this is not the case with many individuals.
            Some people look 20 years old at their 30 while some look 40 years
            old at their 30. Estimating a person&#39;s age on the basis of their
            physical characteristics like look, beauty, personality, etc is
            appearance age.
            <br />
            <br />
          ...
          <BoxContainer heading="Biological Age" >
            ...
            functional capacity of the human body and how long a person will
            live. True Biological age is calculated with the help of biomarkers
            ...
            Biological age is crucial to predict proneness to age-related
            diseases and lifespan as it provides precise standards. Your
            Biological age can be higher or lower than your chronological age
            and is totally controllable. You may become biologically younger by
            adopting a healthy lifestyle.
          </BoxContainer>
          <BoxContainer headingClass="w-full" heading="Mental Age">
            Mental age is a measure of intelligence performance level compared
            to average intelligence based on chronological age. The individual
            will be considered normal if his/her mental age is the same as
            chronological age. Mental age and chronological age provide a
            standard to measure the Intelligent quotient. <br />
            <br />
            The formula is IQ = MA/CA X 100
            <br />
            <br />
            Alfred Binet, a French psychologist, discovered the concept of
            mental age in 1905. Mental age is estimated based on a standardized
            mean score and a child&#39;s performance score on a traditional
            Neuropsychological or Intelligence test. For Instance, if the
            standardized mean score for 5 yrs child is 7/20, then 11 yrs child
            who scores 7/20 will have a mental age of 5 years.  <br />
            <br />
            ...
            judging, and comprehending abilities, while it is less significant
            for adult as intelligence growth become slower.
          </BoxContainer>
          <BoxContainer heading="Functional Age" containerClass="sm:w-[100%]">
            ...
            Functional capacity includes both physical and mental functioning.
            The Functional age of a person with a disability is either not
            calculated or considered zero. <br />
            ...
            speed, and agility come into consideration while measuring
            functional age. <br />
            <br />
